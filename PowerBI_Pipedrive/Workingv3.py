...
json_deal = requests.get('https://skylarkdrones.pipedrive.com/v1/persons?status=all_not_deleted&start=0&limit=500&api_token=d4d19d807af6c5e9861b0fa81d1cf403ea88e402')
...
json_deal_fields = requests.get('https://skylarkdrones.pipedrive.com/v1/personFields?api_token=d4d19d807af6c5e9861b0fa81d1cf403ea88e402')
...
json_table_3 = {'name':'persons', 'columns':final_list_of_columns}
with open('persons_table','w') as file:
    json.dump(json_table_3,file)
...
#
# json_tables = [json_table_1, json_table_2, json_table_3]
# json_data_set = {'name':'Skylark_Official', 'tables':json_tables}
...
with open('rows_persons','w') as r:
    json.dump(row_final,r)

with open('see_row_final_persons','w') as file:
