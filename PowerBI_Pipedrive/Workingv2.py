...
json_deal = requests.get('https://skylarkdrones.pipedrive.com/v1/organizations?status=all_not_deleted&start=0&limit=500&api_token=d4d19d807af6c5e9861b0fa81d1cf403ea88e402')
...
json_deal_fields = requests.get('https://skylarkdrones.pipedrive.com/v1/organizationFields?api_token=d4d19d807af6c5e9861b0fa81d1cf403ea88e402')
...
json_table_1 = {'name':'organizations', 'columns':final_list_of_columns}
with open('organizations_table','w') as file:
...
with open('rows_organizations','w') as r:
    json.dump(row_final,r)

with open('see_row_final_organization','w') as file:
